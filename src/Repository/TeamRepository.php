...
class TeamRepository extends ServiceEntityRepository
{
    ...
    public function getPlayerList(Team $team): array
    {
        ...
        $sql = sprintf('SELECT p.id, p.name, p.surname, pt.cost worth , p.slug FROM %s p inner join %s pt on p.id = pt.player_id and pt.team_id = %d and pt.is_current_team= true', $playerTable, $playerTeamTable, $team->getId());
